export const Contact = () => {
  return (
    <section className='px-6 py-6 max-w-3xl mx-auto'>
      ...
      <form className='bg-slate-50 shadow rounded-xl p-6 flex flex-col gap-4 border border-slate-200'>
        <input
          type='text'
          placeholder='Nombre completo'
          className='p-2 rounded-md border outline-slate-300 border-slate-300 focus:outline-[#1183d4]'
        />
        <input
          type='email'
        ...
        <button
          type='submit'
          className='bg-[#1183d4] hover:bg-[#0e6fb4] text-white rounded-md py-2 font-semibold cursor-pointer transition-colors'
        >
          Enviar mensaje
        </button>
      </form>
